...
from pam_mmpose.models.necks import PoseWarperNeck
...
def test_posewarper_neck():
    ...
    # by it in pam_mmcv.ops.deform_conv
    b_0 = 8  # batch_size
    b_1 = 16
    h_0 = 4  # image height
    h_1 = 2
    ...
    # 'im2col_step' in pam_mmcv.ops.deform_conv, but can not be divided by it
