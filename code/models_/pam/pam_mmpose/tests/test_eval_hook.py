...
from pam_mmcv.runner import EpochBasedRunner, build_optimizer
from pam_mmcv.utils import get_logger
from torch.utils.data import DataLoader, Dataset

from pam_mmpose.core import DistEvalHook, EvalHook
...
@patch('pam_mmpose.apis.single_gpu_test', MagicMock)
@patch('pam_mmpose.apis.multi_gpu_test', MagicMock)
