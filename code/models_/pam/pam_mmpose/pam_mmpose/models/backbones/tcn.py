...
from pam_mmcv.cnn import ConvModule, build_conv_layer, constant_init, kaiming_init
from pam_mmcv.utils.parrots_wrapper import _BatchNorm

from pam_mmpose.core import WeightNormClipHook
...
class TCN(BaseBackbone):
    ...
    Example:
        >>> from pam_mmpose.models import TCN
        >>> import torch
