...
from pam_mmcv.cnn import (ConvModule, MaxPool2d, constant_init, kaiming_init,
                      normal_init)
from pam_mmcv.runner.checkpoint import load_state_dict
...
class MSPN(BaseBackbone):
    ...
    Example:
        >>> from pam_mmpose.models import MSPN
        >>> import torch
