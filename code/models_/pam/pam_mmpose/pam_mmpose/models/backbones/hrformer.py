...
from pam_mmcv.cnn import (build_activation_layer, build_conv_layer,
                      build_norm_layer, trunc_normal_init)
from pam_mmcv.cnn.bricks.transformer import build_dropout
from pam_mmcv.runner import BaseModule
...
class HRFormer(HRNet):
    ...
    Example:
        >>> from pam_mmpose.models import HRFormer
        >>> import torch
        >>> extra = dict(
        >>>     stage1=dict(
        >>>         num_modules=1,
