...
from pam_mmcv.cnn import (ConvModule, build_activation_layer, build_conv_layer,
...
try:
    from pam_mmcv.ops import DeformConv2d
    has_mmcv_full = True
...
class AdaptiveActivationBlock(nn.Module):
    ...
    def __init__(self,
        ...
        if has_mmcv_full:
            ...
            raise ImportError('Please install the full version of pam_mmcv '
                              'to use `DeformConv2d`.')
