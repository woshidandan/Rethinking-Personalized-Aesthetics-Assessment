...
from pam_mmpose.apis import (get_track_id, inference_top_down_pose_model,
                         init_pose_model)
from pam_mmpose.core import Smoother
...
class PoseTrackerNode(Node):
    ...
    Example::
        ...
        >>> from pam_mmpose.apis.webcam.nodes import NODES
    ...
    def __init__(
        ...
        self.pose_model_config = get_config_path(pose_model_config, 'pam_mmpose')
        ...
        if smooth:
            smooth_filter_cfg = get_config_path(smooth_filter_cfg, 'pam_mmpose')
