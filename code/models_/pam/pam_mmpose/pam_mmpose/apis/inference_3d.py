...
from pam_mmpose.core.bbox import bbox_xywh2cs, bbox_xywh2xyxy, bbox_xyxy2xywh
from pam_mmpose.datasets.pipelines import Compose
...
def inference_pose_lifter_model(model,
    ...
    for seq in pose_sequences_2d:
        ...
        # Dummy 3D input
        # This is for compatibility with configs in pam_mmpose<=v0.14.0, where a
        ...
        # Dummy image path
        # This is for compatibility with configs in pam_mmpose<=v0.14.0, where
