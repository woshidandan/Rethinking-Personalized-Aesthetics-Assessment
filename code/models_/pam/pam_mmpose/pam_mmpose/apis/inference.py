...
import numpy as np
import torch
from pam_mmcv.parallel import collate, scatter
from pam_mmcv.runner import load_checkpoint
from pam_mmcv.utils.misc import deprecated_api_warning
from PIL import Image

from pam_mmpose.core.bbox import bbox_xywh2xyxy, bbox_xyxy2xywh
from pam_mmpose.core.post_processing import oks_nms
from pam_mmpose.datasets.dataset_info import DatasetInfo
from pam_mmpose.datasets.pipelines import Compose, ToTensor
from pam_mmpose.models import build_posenet
from pam_mmpose.utils.hooks import OutputHook
...
def init_pose_model(config, checkpoint=None, device='cuda:0'):
    ...
    Args:
        config (str or :obj:`pam_mmcv.Config`): Config file path or the config
            object.
...
def collect_multi_frames(video, frame_id, indices, online=False):
    ...
    Args:
        video (pam_mmcv.VideoReader): A VideoReader of the input video file.
