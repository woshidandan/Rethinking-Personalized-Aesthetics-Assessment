...
from pam_mmcv.runner import DistEvalHook as _DistEvalHook
from pam_mmcv.runner import EvalHook as _EvalHook
...
class EvalHook(_EvalHook):
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from pam_mmpose.apis import single_gpu_test
...
class DistEvalHook(_DistEvalHook):
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from pam_mmpose.apis import multi_gpu_test
