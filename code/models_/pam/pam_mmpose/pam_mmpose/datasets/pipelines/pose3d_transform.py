...
from pam_mmpose.core.camera import CAMERAS
from pam_mmpose.core.post_processing import (affine_transform, fliplr_regression,
                                         get_affine_transform)
from pam_mmpose.datasets.builder import PIPELINES
...
class NormalizeJointCoordinate:
    ...
    Args:
        ...
        norm_param_file (str): Optionally load a dict containing `mean` and
            `std` from a file using `pam_mmcv.load`.
