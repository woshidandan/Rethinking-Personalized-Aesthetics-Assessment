...
import mmcv
from pam_mmcv.runner import build_runner
from pam_mmcv.utils import get_logger
...
@patch('pam_mmcv.runner.EpochBasedRunner.train', epoch_train)
@patch('pam_mmcv.runner.IterBasedRunner.train', iter_train)
@patch('pam_mmcv.runner.hooks.TextLoggerHook.log', log)
def run(cfg, logger):
...
def main():
    ...
    logger = get_logger('pam_mmcv', log_path)
