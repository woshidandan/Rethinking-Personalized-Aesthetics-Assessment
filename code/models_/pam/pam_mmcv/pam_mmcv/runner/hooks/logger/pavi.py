...
import mmcv
from pam_mmcv.parallel.scatter_gather import scatter
from pam_mmcv.parallel.utils import is_module_wrapper
from pam_mmcv.runner.dist_utils import master_only
...
class PaviLoggerHook(LoggerHook):
    ...
    def _add_graph(self, runner, step: int) -> None:
        from pam_mmcv.runner.iter_based_runner import IterLoader
