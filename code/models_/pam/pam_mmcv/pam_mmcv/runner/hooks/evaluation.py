...
from pam_mmcv.utils import is_seq_of
...
class EvalHook(Hook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            ...
            test function ``pam_mmcv.engine.single_gpu_test`` will be used.
            (default: ``None``)
        ...
        file_client_args (dict): Arguments to instantiate a FileClient.
            See :class:`pam_mmcv.fileio.FileClient` for details. Default: None.
            `New in version 1.3.16.`
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from pam_mmcv.engine import single_gpu_test
    ...
    def evaluate(self, runner, results):
        ...
        Args:
            runner (:obj:`pam_mmcv.Runner`): The underlined training runner.
...
class DistEvalHook(EvalHook):
    ...
    Args:
        ...
        test_fn (callable, optional): test a model with samples from a
            ...
            ``None``, the default test function ``pam_mmcv.engine.multi_gpu_test``
            will be used. (default: ``None``)
    ...
    def __init__(self,
        ...
        if test_fn is None:
            from pam_mmcv.engine import multi_gpu_test
