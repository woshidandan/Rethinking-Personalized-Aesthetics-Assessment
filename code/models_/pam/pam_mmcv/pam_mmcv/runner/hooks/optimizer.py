...
from pam_mmcv.utils import TORCH_VERSION, _BatchNorm, digit_version
...
if (TORCH_VERSION != 'parrots'
    ...
    class Fp16OptimizerHook(OptimizerHook):
        ...
        Args:
            loss_scale (float | str | dict): Scale factor configuration.
                ...
                Defaults to 512. For Pytorch >= 1.6, pam_mmcv uses official
    ...
    class Fp16OptimizerHook(OptimizerHook):  # type: ignore
        """FP16 optimizer hook (pam_mmcv's implementation).
    ...
    class GradientCumulativeFp16OptimizerHook(  # type: ignore
        ...
        """Fp16 optimizer Hook (using pam_mmcv implementation) implements multi-
