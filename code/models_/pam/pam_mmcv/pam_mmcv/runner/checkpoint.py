...
def _get_mmcv_home() -> str:
    mmcv_home = os.path.expanduser(
        os.getenv(
            ENV_MMCV_HOME,
            os.path.join(
                os.getenv(ENV_XDG_CACHE_HOME, DEFAULT_CACHE_DIR), 'pam_mmcv')))
...
def load_from_ceph(filename: str,
    ...
    .. warning::
        :class:`pam_mmcv.fileio.file_client.CephBackend` will be deprecated,
        please use :class:`pam_mmcv.fileio.file_client.PetrelBackend` instead.
