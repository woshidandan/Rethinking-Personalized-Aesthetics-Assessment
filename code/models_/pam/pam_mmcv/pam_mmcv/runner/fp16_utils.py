...
from pam_mmcv.utils import TORCH_VERSION, digit_version
from .dist_utils import allreduce_grads as _allreduce_grads

try:
    # If PyTorch version >= 1.6.0, torch.cuda.amp.autocast would be imported
    # and used; otherwise, auto fp16 will adopt pam_mmcv's implementation.
...
def auto_fp16(
    ...
    backend, otherwise, original pam_mmcv implementation will be adopted.
...
def force_fp32(apply_to: Optional[Iterable] = None,
    ...
    torch.cuda.amp is used as the backend, otherwise, original pam_mmcv
...
def allreduce_grads(params: List[Parameter],
    ...
    warnings.warn(
        '"pam_mmcv.runner.fp16_utils.allreduce_grads" is deprecated, and will be '
        'removed in v2.8. Please switch to "pam_mmcv.runner.allreduce_grads',
        DeprecationWarning)
