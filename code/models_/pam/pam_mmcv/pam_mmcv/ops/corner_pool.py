...
class TopPoolFunction(Function):
    ...
    def symbolic(g, input: Tensor) -> Tensor:
        output = g.op(
            'pam_mmcv::MMCVCornerPool', input, mode_i=int(_mode_dict['top']))
        return output
...
class BottomPoolFunction(Function):
    ...
    def symbolic(g, input: Tensor) -> Tensor:
        output = g.op(
            'pam_mmcv::MMCVCornerPool', input, mode_i=int(_mode_dict['bottom']))
        return output
...
class LeftPoolFunction(Function):
    ...
    def symbolic(g, input: Tensor) -> Tensor:
        output = g.op(
            'pam_mmcv::MMCVCornerPool', input, mode_i=int(_mode_dict['left']))
        return output
...
class RightPoolFunction(Function):
    ...
    def symbolic(g, input: Tensor) -> Tensor:
        output = g.op(
            'pam_mmcv::MMCVCornerPool', input, mode_i=int(_mode_dict['right']))
        return output
