...
from pam_mmcv import get_git_hash, parse_version_info
...
def test_get_git_hash():
    with patch('pam_mmcv.utils.version_utils._minimal_ext_cmd', _mock_cmd_success):
    ...
    with patch('pam_mmcv.utils.version_utils._minimal_ext_cmd', _mock_cmd_fail):
