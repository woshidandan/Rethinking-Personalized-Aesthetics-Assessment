...
from pam_mmcv.parallel.data_container import DataContainer
from pam_mmcv.utils import IS_IPU_AVAILABLE

if IS_IPU_AVAILABLE:
    from pam_mmcv.device.ipu import IPUDataLoader, cfg2options
    from pam_mmcv.device.ipu.dataloader import collate
