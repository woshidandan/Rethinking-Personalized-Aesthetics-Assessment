...
from pam_mmcv.fileio.file_client import PetrelBackend
from pam_mmcv.runner import DistEvalHook as BaseDistEvalHook
from pam_mmcv.runner import EpochBasedRunner
from pam_mmcv.runner import EvalHook as BaseEvalHook
from pam_mmcv.runner import IterBasedRunner
from pam_mmcv.utils import get_logger, scandir
...
@patch('pam_mmcv.engine.single_gpu_test', MagicMock)
@patch('pam_mmcv.engine.multi_gpu_test', MagicMock)
