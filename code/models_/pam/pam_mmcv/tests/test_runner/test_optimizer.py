...
from pam_mmcv.runner import OPTIMIZER_BUILDERS, DefaultOptimizerConstructor
from pam_mmcv.runner.optimizer import build_optimizer, build_optimizer_constructor
from pam_mmcv.runner.optimizer.builder import TORCH_OPTIMIZERS
from pam_mmcv.utils.ext_loader import check_ops_exist

OPS_AVAILABLE = check_ops_exist()
if not OPS_AVAILABLE:
    sys.modules['pam_mmcv.ops'] = MagicMock(
