...
from pam_mmcv.parallel.registry import MODULE_WRAPPERS
from pam_mmcv.runner.checkpoint import (_load_checkpoint_with_prefix,
...
def test_load_checkpoint_metadata():
    ...
    from pam_mmcv.runner import load_checkpoint, save_checkpoint
...
def test_checkpoint_loader():
    ...
    from pam_mmcv.runner import CheckpointLoader, _load_checkpoint, save_checkpoint
    checkpoint_path = os.path.join(tempfile.gettempdir(), 'checkpoint.pth')
    model = Model()
    save_checkpoint(model, checkpoint_path)
