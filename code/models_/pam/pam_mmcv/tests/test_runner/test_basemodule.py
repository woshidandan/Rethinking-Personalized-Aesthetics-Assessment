...
import mmcv
from pam_mmcv.cnn.utils.weight_init import update_init_info
from pam_mmcv.runner import BaseModule, ModuleDict, ModuleList, Sequential
from pam_mmcv.utils import Registry, build_from_cfg
...
def test_initilization_info_logger():
    ...
    from pam_mmcv.utils.logging import get_logger
