...
class TestPhotometric:
    ...
    def test_adjust_contrast(self, nb_rand_test=100):
        ...
        for _ in range(nb_rand_test):
            ...
            # and pam_mmcv.adjust_contrast comes from the gap that converts from
            # a color image to gray image using pam_mmcv or PIL.
            np.testing.assert_allclose(
    ...
    def test_adjust_sharpness(self, nb_rand_test=100):
        ...
        for _ in range(nb_rand_test):
            ...
            # pam_mmcv.adjust_sharpness mainly comes from the difference ways of
