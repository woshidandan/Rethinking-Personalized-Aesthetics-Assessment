...
from pam_mmcv.parallel import (MODULE_WRAPPERS, MMDataParallel,
                           MMDistributedDataParallel, is_module_wrapper)
from pam_mmcv.parallel._functions import Scatter, get_input_device, scatter
from pam_mmcv.parallel.distributed_deprecated import \
...
def test_is_module_wrapper():
    ...
    MMPOSE_MODULE_WRAPPERS = Registry(
        'pam_mmpose module wrapper', parent=MODULE_WRAPPERS, scope='pam_mmpose')
