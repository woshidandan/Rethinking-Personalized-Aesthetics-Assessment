...
from pam_mmcv.cnn import (build_activation_layer, build_norm_layer, xavier_init)
from pam_mmcv.cnn.bricks.registry import (TRANSFORMER_LAYER,
                                      TRANSFORMER_LAYER_SEQUENCE)
from pam_mmcv.cnn.bricks.transformer import (BaseTransformerLayer,
                                         TransformerLayerSequence,
                                         build_transformer_layer_sequence)
from pam_mmcv.runner.base_module import BaseModule
...
class DetrTransformerDecoderLayer(BaseTransformerLayer):
    ...
    Args:
        attn_cfgs (list[`pam_mmcv.ConfigDict`] | list[dict] | dict )):
