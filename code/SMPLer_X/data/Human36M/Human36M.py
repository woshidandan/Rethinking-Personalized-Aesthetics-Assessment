...
from utils_smpler_x.preprocessing import load_img, process_bbox, augmentation, process_db_coord, process_human_model_output, get_fitting_error_3D
...
class Human36M(torch.utils.data.Dataset):
    ...
    def evaluate(self, outs, cur_sample_idx):
        ...
        for n in range(sample_num):
            ...
            vis = False
            if vis:
                from utils_smpler_x.vis import vis_keypoints, vis_mesh, save_obj
