...
class OneEuroFilter:
    ...
    def __init__(self,
        ...
        warnings.warn(
            'OneEuroFilter from '
            '`pam_mmpose/core/post_processing/one_euro_filter.py` will '
            'be deprecated in the future. Please use Smoother'
            '(`pam_mmpose/core/post_processing/smoother.py`) with '
            'OneEuroFilter (`pam_mmpose/core/post_processing/temporal_'
