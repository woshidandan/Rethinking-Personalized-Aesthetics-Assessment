...
from utils_smpler_x.inference_utils import process_mmdet_results, non_max_suppression
...
def main():
    ...
    from utils_smpler_x.preprocessing import load_img, process_bbox, generate_patch_image
    from utils_smpler_x.vis import render_mesh, save_obj
    ...
    img_path = "/data1/Cosmicman/zhb/PAA_dataset_new/bodybuilding_4_x.jpg"
